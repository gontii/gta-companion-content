...
Supadata: wyłącznie `mode=native`, angielskie napisy ze znacznikami czasu, bez generowania audio i doładowań. Lokalny limit 95 kredytów na miesiąc zostawia margines względem darmowych 100. Rezerwacja następuje przed żądaniem, także niepewna próba zużywa rezerwację. Do 4 prób w pierwszej dobie, później jedna dziennie. Zadania 202 są odpytywane osobno. Prywatna transkrypcja i wynik wyodrębnienia mają retencję 30 dni; pełna transkrypcja nie trafia do Git ani do aplikacji.
